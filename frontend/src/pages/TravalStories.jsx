// //C:\Users\DELL\Documents\Cadt\cadty3t2\New folder (2)\DerLeng-Web-application-platform\frontend\src\pages\TravalStories.jsx
...
export default function TravelStories() {
  const { stories, loading } = useTravelStories();
  const [search, setSearch] = useState("");
        ...
        <div className="flex justify-between items-end mb-8">
          ...
          <div className="relative">
            <input
              ...
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              className="border py-2 pl-10 pr-3 rounded-sm"
            />
            <Search
              size={16}
